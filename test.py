...
class MyProxies(spider.Proxieser):
    ...
    def proxies_get(self):
        ...
        """
        response = requests.get("https://www.ixigua.com/home/800093389722574/")
...
def test_spider():
    ...
    # 添加起始的url
    web_spider.set_start_url("https://www.ixigua.com/home/800093389722574/", priority=0, keys={"type": "index"}, deep=0, repeat=0)
